    ...
    def update(self, detections, timestamp, intrinsics, world2pv_transform, img_shape, **kwargs):
        ...
        for idx, d in enumerate(detections):
            for k, o in self.objects.items():
                ...
                if self.xmemScore(d, o) and (d.label == 'bowl' or d.label in {'plate', 'tortilla', 'mug'} and 'hand_object_interaction' in d.detection and d.detection['hand_object_interaction'] > 0.5):
